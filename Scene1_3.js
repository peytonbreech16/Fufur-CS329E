...
class Scene1_3 extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        var tree3 = trees.create(180,52,'tallTree');
        tree3.body.setCircle(50);
        tree3.body.setOffset(-20, 40);

        var tree4 = trees.create(75,525,'tallTree');
        tree4.body.setCircle(50);
        tree4.body.setOffset(-10, 10);
        ...
        var stump1 = trees.create(430,240,'bigStump');
        stump1.body.setCircle(30);
        stump1.body.setOffset(25, -5);

        this.add.image(550,245,'hPath').setScale(1.3);
        this.add.image(610,245,'hPath').setScale(1.3);
        this.add.image(670,245,'hPath').setScale(1.3);
        this.add.image(730,245,'hPath').setScale(1.3);
        this.add.image(790,245,'hPath').setScale(1.3);

        var grass = this.add.image(140,170,'grass');
        grass.flipX = true;
        grass = this.add.image(70,400,'grass');
        grass.flipY = true;
        this.add.image(340,530,'grass');
        grass = this.add.image(400,100,'grass');
        grass.flipX = true;
        grass.flipY = true;
        this.add.image(515,330,'grass');

        this.add.image(215,360,'dirt').setScale(1.8);
        var dirt = this.add.image(215,380,'dirt').setScale(1.8);
        dirt.flipY = true;
        dirt.flipX = true
    ...
    {
        prevRoom = "Scene1_3";
        this.scene.start("Scene2_3", {x: playerX, y: 550});
    }

    moveRoomDown(player, bottomBorder)
    {
        prevRoom = "Scene1_3";
        this.scene.start("Scene0_3", {x: playerX, y: 50});
    }

    moveRoomLeft(player, leftBorder)
    {
        prevRoom = "Scene1_3";
        this.scene.start("Scene1_2", {x: 750, y: playerY});
    }

    moveRoomRight(player, rightBorder)
    {
        prevRoom = "Scene1_3";
        this.scene.start("Scene1_4", {x: 50, y: playerY});
    }
