...
class Scene2_3 extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        dirt.flipX = true;
        this.add.image(710,235,'dirt');
        dirt = this.add.image(80,170,'dirt').setScale(1.2);
        dirt.flipY = true;

        var grass = this.add.image(120,330,'grass');
        grass.flipX = true;
        grass = this.add.image(310,130,'grass');
        grass.flipY = true;
        this.add.image(420,85,'grass');
        grass = this.add.image(610,415,'grass');
        grass.flipX = true;
        grass.flipY = true;
    ...
    {
        prevRoom = "Scene2_3";
        this.scene.start("Scene3_3", {x: playerX, y: 550});
    }

    moveRoomDown(player, bottomBorder)
    {
        prevRoom = "Scene2_3";
        this.scene.start("Scene1_3", {x: playerX, y: 50});
    }

    moveRoomLeft(player, leftBorder)
    {
        prevRoom = "Scene2_3";
        this.scene.start("Scene2_2", {x: 750, y: playerY});
    }

    moveRoomRight(player, rightBorder)
    {
        prevRoom = "Scene2_3";
        this.scene.start("Scene2_4", {x: 50, y: playerY});
    }
};
